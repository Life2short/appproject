...
class LoginView(Common):
    ...
    def login_action(self,username,password):
        ...
        self.wait_element(self.username_type).send_keys(username)

        logging.info('password is:%s'%password)
        self.wait_element(self.password_type).send_keys(password)

        logging.info('click loginBtn')
        self.wait_element(self.loginBtn).click()
    ...
    def check_loginStatus(self):
        ...
        self.driver.tap([(win_size[0]/2, win_size[1]/2)], 500)

        try:

            self.wait_element(self.button_mysefl).click()
    ...
    def logout_action(self):
        ...
        self.wait_element(self.button_mysefl).click()
        self.wait_element(self.username)
        self.wait_element(self.RightButton).click()
        self.wait_element(self.logoutBtn).click()
        self.wait_element(self.tip_commit).click()
